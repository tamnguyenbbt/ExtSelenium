...
//find by xpath --> have to construct the xpath manually
IWebElement firstNameInput = driver.FindElementByXPath("//label[span[text()='First name']]/input");

//what you see is what you may get approach --> save scripting time
